...
(function (angular) {
    ...
    drctv.factory('joyrideElement', [
        ...
        function Element(config, currentStep, template, loadTemplateFn,
                         hasReachedEndFn, goToNextFn, goToPrevFn, skipDemoFn,
                         isEnd, curtainClass , addClassToCurtain,
                         shouldDisablePrevious, attachTobody) {
        ...
        Element.prototype = (function() {
            ...
            function generate() {
                ...
                return _generateHtml.call(this)
